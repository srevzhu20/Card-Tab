...
<body>
	...
	<p><a style="color: #0000FF;">搭建各类导航博客节点代码</a></p>
        ...
        <div class="top-right-controls">
            ...
            <button class="github-btn has-tooltip tooltip-bottom tooltip-green" onclick="openGitHub()" data-tooltip="请点个星星">
    ...
    // 打开GitHub仓库
    function openGitHub() {
        window.open('https://github.com/srevzhu20/Card-Tab', '_blank');
